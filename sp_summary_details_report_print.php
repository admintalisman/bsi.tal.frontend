...
require_once("include/sp_summary_details_report_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "sp_summary_details_report" );
