...
function checkTableName($shortTName )
{
	...
	if ("login" == $shortTName )
		return true;
	if ("tempbsicile" == $shortTName )
		return true;
	if ("v1" == $shortTName )
		return true;
	if ("report_upload_file" == $shortTName )
		return true;
	if ("upload_cabang" == $shortTName )
		return true;
	if ("tempbsicile_view" == $shortTName )
		return true;
	if ("hasil_proses_api" == $shortTName )
		return true;
	if ("hasil_proses_api1" == $shortTName )
		return true;
	if ("surat" == $shortTName )
		return true;
	if ("upload_year_month" == $shortTName )
		return true;
	if ("total_premi_si" == $shortTName )
		return true;
	if ("tempbsicile_view1" == $shortTName )
		return true;
	if ("tempbsicit" == $shortTName )
		return true;
	if ("tembsicitasal" == $shortTName )
		return true;
	if ("tembsicittujuan" == $shortTName )
		return true;
	if ("tempbsicis" == $shortTName )
		return true;
	if ("tempbsicis_view" == $shortTName )
		return true;
	if ("v2" == $shortTName )
		return true;
	if ("v3" == $shortTName )
		return true;
	if ("tempbsicis_view1" == $shortTName )
		return true;
	if ("tempbsicis_view2" == $shortTName )
		return true;
	if ("tempbsicis_view3" == $shortTName )
		return true;
	...
	if ("v4" == $shortTName )
		return true;
	if ("tempbsicit_view" == $shortTName )
		return true;
	if ("tempbsicit_view1" == $shortTName )
		return true;
	if ("tempbsicit_view2" == $shortTName )
		return true;
	if ("sp_summary_details_report" == $shortTName )
		return true;
	if ("sp_summary_product" == $shortTName )
		return true;
	if ("chart_summary_report" == $shortTName )
		return true;
	if ("chart_summary_report_view" == $shortTName )
		return true;
	if ("getbsibranch" == $shortTName )
		return true;
	if ("soa_cis_view" == $shortTName )
		return true;
	if ("report_cis_view" == $shortTName )
		return true;
	if ("tempbsicit_verifikasi" == $shortTName )
		return true;
	if ("soa_cit_view" == $shortTName )
		return true;
	if ("soa_cis_view1" == $shortTName )
		return true;
	if ("soa_cit_view1" == $shortTName )
		return true;
	if ("report_product_month" == $shortTName )
		return true;
	if ("report_product_month_view" == $shortTName )
		return true;
	if ("tembsicitasal_verifikasi" == $shortTName )
		return true;
	if ("tempbsicis_kc" == $shortTName )
		return true;
	if ("tempbsicis_atm" == $shortTName )
		return true;
	if ("bsibranch" == $shortTName )
		return true;
	if ("tempbsicis_ol" == $shortTName )
		return true;
	if ("bsivehicle" == $shortTName )
		return true;
	if ("bsivehlimit" == $shortTName )
		return true;
	if ("m_resiko" == $shortTName )
		return true;
	if ("tempbsicit_coll" == $shortTName )
		return true;
	if ("tempbsicit_cit" == $shortTName )
		return true;
	if ("bsivehlimit_view" == $shortTName )
		return true;
	if ("tembsicitasal_view" == $shortTName )
		return true;
	if ("bsiapprv" == $shortTName )
		return true;
	if ("tempbsicit_resume" == $shortTName )
		return true;
	if ("tempbsicit_apprv" == $shortTName )
		return true;
	if ("bsivehlimit_col" == $shortTName )
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("LOGIN");
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMPBSICILE");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("report_upload_file");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="report_upload_file";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Upload_cabang");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMPBSICILE_view");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="TEMPBSICILE_view";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("hasil_proses_api");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="hasil_proses_api";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("hasil_proses_api1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="hasil_proses_api1";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("SURAT");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("upload_year_month");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="upload_year_month";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TOTAL_PREMI_SI");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMPBSICILE_view1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="TEMPBSICILE_view1";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMPBSICIT");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMBSICITASAL");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMBSICITTUJUAN");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMPBSICIS");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMPBSICIS_view");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMPBSICIS_view1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="TEMPBSICIS_view1";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMPBSICIS_view2");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="TEMPBSICIS_view2";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMPBSICIS_view3");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="TEMPBSICIS_view3";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMPBSICIT_view");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMPBSICIT_view1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="TEMPBSICIT_view1";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMPBSICIT_view2");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="TEMPBSICIT_view2";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("sp_summary_details_report");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="sp_summary_details_report";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("sp_summary_product");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="sp_summary_product";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Chart_summary_report");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Chart_summary_report";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Chart_summary_report_view");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="Chart_summary_report_view";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("getbsibranch");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("SOA_CIS_view");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("REPORT_CIS_view");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMPBSICIT_verifikasi");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="TEMPBSICIT_verifikasi";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("SOA_CIT_view");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("SOA_CIS_view1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("SOA_CIT_view1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("report_product_Month");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="report_product_Month";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("report_product_Month_view");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="report_product_Month_view";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMBSICITASAL_verifikasi");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="TEMBSICITASAL_verifikasi";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMPBSICIS_KC");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMPBSICIS_ATM");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("BSIBRANCH");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMPBSICIS_OL");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("BSIVEHICLE");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("BSIVEHLIMIT");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("M_RESIKO");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMPBSICIT_COLL");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMPBSICIT_CIT");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("BSIVEHLIMIT_view");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="BSIVEHLIMIT_view";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMBSICITASAL_view");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="TEMBSICITASAL_view";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("BSIAPPRV");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMPBSICIT_RESUME");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="TEMPBSICIT_RESUME";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("TEMPBSICIT_APPRV");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="TEMPBSICIT_APPRV";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("BSIVEHLIMIT_COL");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
...
{
	if($shorttable=="tempbsicile_view")
		return "2DDoughnut";
	if($shorttable=="tempbsicis_view2")
		return "2DColumn";
	if($shorttable=="tempbsicit_view2")
		return "2DColumn";
	if($shorttable=="chart_summary_report_view")
		return "2DPie";
	if($shorttable=="report_product_month_view")
		return "2DDoughnut";
	return "";
}
...
//	default permissions
	...
	if( $table=="report_upload_file" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="Upload_cabang" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="TEMPBSICILE_view" )
	{
//	default permissions
		return "S".$extraPerm;
	}
	if( $table=="hasil_proses_api" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="hasil_proses_api1" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="upload_year_month" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="TOTAL_PREMI_SI" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="TEMPBSICILE_view1" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="TEMBSICITASAL" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="TEMBSICITTUJUAN" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="TEMPBSICIS_view1" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="TEMPBSICIS_view2" )
	{
//	default permissions
		return "S".$extraPerm;
	}
	if( $table=="TEMPBSICIS_view3" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="TEMPBSICIT_view" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="TEMPBSICIT_view1" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="TEMPBSICIT_view2" )
	{
//	default permissions
		return "S".$extraPerm;
	}
	if( $table=="sp_summary_details_report" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="sp_summary_product" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="Chart_summary_report" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="Chart_summary_report_view" )
	{
//	default permissions
		return "S".$extraPerm;
	}
	if( $table=="getbsibranch" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="SOA_CIS_view" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="REPORT_CIS_view" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="TEMPBSICIT_verifikasi" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="SOA_CIT_view" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="SOA_CIS_view1" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="SOA_CIT_view1" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="report_product_Month" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="report_product_Month_view" )
	{
//	default permissions
		return "S".$extraPerm;
	}
	if( $table=="TEMBSICITASAL_verifikasi" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="TEMPBSICIS_KC" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="TEMPBSICIS_ATM" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="TEMPBSICIT_COLL" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="TEMPBSICIT_CIT" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="BSIVEHLIMIT_view" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="TEMBSICITASAL_view" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="TEMPBSICIT_RESUME" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="TEMPBSICIT_APPRV" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="BSIVEHLIMIT_COL" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
