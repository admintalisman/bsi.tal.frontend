...
class EditPage extends RunnerPage
{
	...
	public static function handleBrokenRequest()
	{
		...
		else
		{
			if( postvalue('fly') )
			{
				...
				$_SESSION["message_edit"] = "<< "."Terjadi kesalahan"." >>";
		}
	}
	...
	protected function setSuccessfulEditMessage()
	{
		...
		$this->setMessage( "<strong>&lt;&lt;&lt; "."Catatan diperbarui". " &gt;&gt;&gt;</strong>" );
	}
	...
	public function setDatabaseError( $message )
	{
		if( $this->mode != EDIT_INLINE )
		{
			$this->message = "<strong>&lt;&lt;&lt; "."Catatan TIDAK diedit"."</strong> &gt;&gt;&gt;<br><br>".$message;
		}
		else
			$this->message = "Catatan TIDAK diedit".". ".$message;
