...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("LOGIN" == $this->chrt_array['tables'][0])
			return true;
		if("TEMPBSICILE" == $this->chrt_array['tables'][0])
			return true;
		...
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("hasil_proses_api" == $this->chrt_array['tables'][0])
			return true;
		if("SURAT" == $this->chrt_array['tables'][0])
			return true;
		if("TEMPBSICILE" == $this->chrt_array['tables'][0])
			return true;
		if("TOTAL_PREMI_SI" == $this->chrt_array['tables'][0])
			return true;
		if("TEMPBSICILE" == $this->chrt_array['tables'][0])
			return true;
		if("TEMPBSICIT" == $this->chrt_array['tables'][0])
			return true;
		if("TEMBSICITASAL" == $this->chrt_array['tables'][0])
			return true;
		if("TEMBSICITTUJUAN" == $this->chrt_array['tables'][0])
			return true;
		if("TEMPBSICIS" == $this->chrt_array['tables'][0])
			return true;
		if("TEMPBSICIS" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
		...
		if("TEMPBSICIS" == $this->chrt_array['tables'][0])
			return true;
		if("LOG_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("LOG_ugmembers" == $this->chrt_array['tables'][0])
			return true;
		if("LOGIN" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
		...
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("Chart_summary_report" == $this->chrt_array['tables'][0])
			return true;
		if("Chart_summary_report" == $this->chrt_array['tables'][0])
			return true;
		if("getbsibranch" == $this->chrt_array['tables'][0])
			return true;
		if("TEMPBSICIT" == $this->chrt_array['tables'][0])
			return true;
		if("TEMPBSICIS" == $this->chrt_array['tables'][0])
		...
		if("TEMPBSICIT" == $this->chrt_array['tables'][0])
			return true;
		if("report_product_Month" == $this->chrt_array['tables'][0])
			return true;
		if("report_product_Month" == $this->chrt_array['tables'][0])
			return true;
		if("TEMBSICITASAL" == $this->chrt_array['tables'][0])
		...
		if("TEMPBSICIS" == $this->chrt_array['tables'][0])
			return true;
		if("BSIBRANCH" == $this->chrt_array['tables'][0])
			return true;
		if("TEMPBSICIS" == $this->chrt_array['tables'][0])
			return true;
		if("BSIVEHICLE" == $this->chrt_array['tables'][0])
			return true;
		if("BSIVEHLIMIT" == $this->chrt_array['tables'][0])
			return true;
		if("M_RESIKO" == $this->chrt_array['tables'][0])
			return true;
		if("TEMPBSICIT" == $this->chrt_array['tables'][0])
			return true;
		if("TEMPBSICIT" == $this->chrt_array['tables'][0])
		...
		if("TEMBSICITASAL" == $this->chrt_array['tables'][0])
			return true;
		if("BSIAPPRV" == $this->chrt_array['tables'][0])
			return true;
		if("TEMPBSICIT_RESUME" == $this->chrt_array['tables'][0])
			return true;
		if("TEMPBSICIT_APPRV" == $this->chrt_array['tables'][0])
			return true;
		if("BSIVEHLIMIT" == $this->chrt_array['tables'][0])
			return true;
		return false;
