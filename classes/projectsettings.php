...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("LOGIN", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	$projectEntities[ "TEMPBSICILE" ] = array( "url" => "tempbsicile", "type" => 0 );
	$projectEntitiesReverse[ "tempbsicile" ] = "TEMPBSICILE";
	$projectEntities[ "v1" ] = array( "url" => "v1", "type" => 4 );
	$projectEntitiesReverse[ "v1" ] = "v1";
	$projectEntities[ "report_upload_file" ] = array( "url" => "report_upload_file", "type" => 1 );
	$projectEntitiesReverse[ "report_upload_file" ] = "report_upload_file";
	$projectEntities[ "Upload_cabang" ] = array( "url" => "upload_cabang", "type" => 1 );
	$projectEntitiesReverse[ "upload_cabang" ] = "Upload_cabang";
	$projectEntities[ "TEMPBSICILE_view" ] = array( "url" => "tempbsicile_view", "type" => 3 );
	$projectEntitiesReverse[ "tempbsicile_view" ] = "TEMPBSICILE_view";
	$projectEntities[ "hasil_proses_api" ] = array( "url" => "hasil_proses_api", "type" => 7 );
	$projectEntitiesReverse[ "hasil_proses_api" ] = "hasil_proses_api";
	$projectEntities[ "hasil_proses_api1" ] = array( "url" => "hasil_proses_api1", "type" => 7 );
	$projectEntitiesReverse[ "hasil_proses_api1" ] = "hasil_proses_api1";
	$projectEntities[ "SURAT" ] = array( "url" => "surat", "type" => 0 );
	$projectEntitiesReverse[ "surat" ] = "SURAT";
	$projectEntities[ "upload_year_month" ] = array( "url" => "upload_year_month", "type" => 1 );
	$projectEntitiesReverse[ "upload_year_month" ] = "upload_year_month";
	$projectEntities[ "TOTAL_PREMI_SI" ] = array( "url" => "total_premi_si", "type" => 0 );
	$projectEntitiesReverse[ "total_premi_si" ] = "TOTAL_PREMI_SI";
	$projectEntities[ "TEMPBSICILE_view1" ] = array( "url" => "tempbsicile_view1", "type" => 1 );
	$projectEntitiesReverse[ "tempbsicile_view1" ] = "TEMPBSICILE_view1";
	$projectEntities[ "TEMPBSICIT" ] = array( "url" => "tempbsicit", "type" => 0 );
	$projectEntitiesReverse[ "tempbsicit" ] = "TEMPBSICIT";
	$projectEntities[ "TEMBSICITASAL" ] = array( "url" => "tembsicitasal", "type" => 0 );
	$projectEntitiesReverse[ "tembsicitasal" ] = "TEMBSICITASAL";
	$projectEntities[ "TEMBSICITTUJUAN" ] = array( "url" => "tembsicittujuan", "type" => 0 );
	$projectEntitiesReverse[ "tembsicittujuan" ] = "TEMBSICITTUJUAN";
	$projectEntities[ "TEMPBSICIS" ] = array( "url" => "tempbsicis", "type" => 0 );
	$projectEntitiesReverse[ "tempbsicis" ] = "TEMPBSICIS";
	$projectEntities[ "TEMPBSICIS_view" ] = array( "url" => "tempbsicis_view", "type" => 2 );
	$projectEntitiesReverse[ "tempbsicis_view" ] = "TEMPBSICIS_view";
	$projectEntities[ "v2" ] = array( "url" => "v2", "type" => 4 );
	$projectEntitiesReverse[ "v2" ] = "v2";
	$projectEntities[ "v3" ] = array( "url" => "v3", "type" => 4 );
	$projectEntitiesReverse[ "v3" ] = "v3";
	$projectEntities[ "TEMPBSICIS_view1" ] = array( "url" => "tempbsicis_view1", "type" => 1 );
	$projectEntitiesReverse[ "tempbsicis_view1" ] = "TEMPBSICIS_view1";
	$projectEntities[ "TEMPBSICIS_view2" ] = array( "url" => "tempbsicis_view2", "type" => 3 );
	$projectEntitiesReverse[ "tempbsicis_view2" ] = "TEMPBSICIS_view2";
	$projectEntities[ "TEMPBSICIS_view3" ] = array( "url" => "tempbsicis_view3", "type" => 1 );
	$projectEntitiesReverse[ "tempbsicis_view3" ] = "TEMPBSICIS_view3";
	...
	$projectEntities[ "v4" ] = array( "url" => "v4", "type" => 4 );
	$projectEntitiesReverse[ "v4" ] = "v4";
	$projectEntities[ "TEMPBSICIT_view" ] = array( "url" => "tempbsicit_view", "type" => 1 );
	$projectEntitiesReverse[ "tempbsicit_view" ] = "TEMPBSICIT_view";
	$projectEntities[ "TEMPBSICIT_view1" ] = array( "url" => "tempbsicit_view1", "type" => 1 );
	$projectEntitiesReverse[ "tempbsicit_view1" ] = "TEMPBSICIT_view1";
	$projectEntities[ "TEMPBSICIT_view2" ] = array( "url" => "tempbsicit_view2", "type" => 3 );
	$projectEntitiesReverse[ "tempbsicit_view2" ] = "TEMPBSICIT_view2";
	$projectEntities[ "sp_summary_details_report" ] = array( "url" => "sp_summary_details_report", "type" => 6 );
	$projectEntitiesReverse[ "sp_summary_details_report" ] = "sp_summary_details_report";
	$projectEntities[ "sp_summary_product" ] = array( "url" => "sp_summary_product", "type" => 6 );
	$projectEntitiesReverse[ "sp_summary_product" ] = "sp_summary_product";
	$projectEntities[ "Chart_summary_report" ] = array( "url" => "chart_summary_report", "type" => 0 );
	$projectEntitiesReverse[ "chart_summary_report" ] = "Chart_summary_report";
	$projectEntities[ "Chart_summary_report_view" ] = array( "url" => "chart_summary_report_view", "type" => 3 );
	$projectEntitiesReverse[ "chart_summary_report_view" ] = "Chart_summary_report_view";
	$projectEntities[ "getbsibranch" ] = array( "url" => "getbsibranch", "type" => 0 );
	$projectEntitiesReverse[ "getbsibranch" ] = "getbsibranch";
	$projectEntities[ "SOA_CIS_view" ] = array( "url" => "soa_cis_view", "type" => 1 );
	$projectEntitiesReverse[ "soa_cis_view" ] = "SOA_CIS_view";
	$projectEntities[ "REPORT_CIS_view" ] = array( "url" => "report_cis_view", "type" => 1 );
	$projectEntitiesReverse[ "report_cis_view" ] = "REPORT_CIS_view";
	$projectEntities[ "TEMPBSICIT_verifikasi" ] = array( "url" => "tempbsicit_verifikasi", "type" => 1 );
	$projectEntitiesReverse[ "tempbsicit_verifikasi" ] = "TEMPBSICIT_verifikasi";
	$projectEntities[ "SOA_CIT_view" ] = array( "url" => "soa_cit_view", "type" => 1 );
	$projectEntitiesReverse[ "soa_cit_view" ] = "SOA_CIT_view";
	$projectEntities[ "SOA_CIS_view1" ] = array( "url" => "soa_cis_view1", "type" => 1 );
	$projectEntitiesReverse[ "soa_cis_view1" ] = "SOA_CIS_view1";
	$projectEntities[ "SOA_CIT_view1" ] = array( "url" => "soa_cit_view1", "type" => 1 );
	$projectEntitiesReverse[ "soa_cit_view1" ] = "SOA_CIT_view1";
	$projectEntities[ "report_product_Month" ] = array( "url" => "report_product_month", "type" => 0 );
	$projectEntitiesReverse[ "report_product_month" ] = "report_product_Month";
	$projectEntities[ "report_product_Month_view" ] = array( "url" => "report_product_month_view", "type" => 3 );
	$projectEntitiesReverse[ "report_product_month_view" ] = "report_product_Month_view";
	$projectEntities[ "TEMBSICITASAL_verifikasi" ] = array( "url" => "tembsicitasal_verifikasi", "type" => 1 );
	$projectEntitiesReverse[ "tembsicitasal_verifikasi" ] = "TEMBSICITASAL_verifikasi";
	$projectEntities[ "TEMPBSICIS_KC" ] = array( "url" => "tempbsicis_kc", "type" => 1 );
	$projectEntitiesReverse[ "tempbsicis_kc" ] = "TEMPBSICIS_KC";
	$projectEntities[ "TEMPBSICIS_ATM" ] = array( "url" => "tempbsicis_atm", "type" => 1 );
	$projectEntitiesReverse[ "tempbsicis_atm" ] = "TEMPBSICIS_ATM";
	$projectEntities[ "BSIBRANCH" ] = array( "url" => "bsibranch", "type" => 0 );
	$projectEntitiesReverse[ "bsibranch" ] = "BSIBRANCH";
	$projectEntities[ "TEMPBSICIS_OL" ] = array( "url" => "tempbsicis_ol", "type" => 1 );
	$projectEntitiesReverse[ "tempbsicis_ol" ] = "TEMPBSICIS_OL";
	$projectEntities[ "BSIVEHICLE" ] = array( "url" => "bsivehicle", "type" => 0 );
	$projectEntitiesReverse[ "bsivehicle" ] = "BSIVEHICLE";
	$projectEntities[ "BSIVEHLIMIT" ] = array( "url" => "bsivehlimit", "type" => 0 );
	$projectEntitiesReverse[ "bsivehlimit" ] = "BSIVEHLIMIT";
	$projectEntities[ "M_RESIKO" ] = array( "url" => "m_resiko", "type" => 0 );
	$projectEntitiesReverse[ "m_resiko" ] = "M_RESIKO";
	$projectEntities[ "TEMPBSICIT_COLL" ] = array( "url" => "tempbsicit_coll", "type" => 1 );
	$projectEntitiesReverse[ "tempbsicit_coll" ] = "TEMPBSICIT_COLL";
	$projectEntities[ "TEMPBSICIT_CIT" ] = array( "url" => "tempbsicit_cit", "type" => 1 );
	$projectEntitiesReverse[ "tempbsicit_cit" ] = "TEMPBSICIT_CIT";
	$projectEntities[ "BSIVEHLIMIT_view" ] = array( "url" => "bsivehlimit_view", "type" => 1 );
	$projectEntitiesReverse[ "bsivehlimit_view" ] = "BSIVEHLIMIT_view";
	$projectEntities[ "TEMBSICITASAL_view" ] = array( "url" => "tembsicitasal_view", "type" => 1 );
	$projectEntitiesReverse[ "tembsicitasal_view" ] = "TEMBSICITASAL_view";
	$projectEntities[ "BSIAPPRV" ] = array( "url" => "bsiapprv", "type" => 0 );
	$projectEntitiesReverse[ "bsiapprv" ] = "BSIAPPRV";
	$projectEntities[ "TEMPBSICIT_RESUME" ] = array( "url" => "tempbsicit_resume", "type" => 0 );
	$projectEntitiesReverse[ "tempbsicit_resume" ] = "TEMPBSICIT_RESUME";
	$projectEntities[ "TEMPBSICIT_APPRV" ] = array( "url" => "tempbsicit_apprv", "type" => 0 );
	$projectEntitiesReverse[ "tempbsicit_apprv" ] = "TEMPBSICIT_APPRV";
	$projectEntities[ "BSIVEHLIMIT_COL" ] = array( "url" => "bsivehlimit_col", "type" => 1 );
	$projectEntitiesReverse[ "bsivehlimit_col" ] = "BSIVEHLIMIT_COL";
}
