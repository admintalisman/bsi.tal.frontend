...
class XTempl_Base
{
	 ...
	 function __construct( $hideAddedCharts = false )
	{
		...
		{
			$this->assign_function("tempbsicile_view_chart","xt_showchart",
			array(
				"chartName"=>"tempbsicile_view",
				"table"=>"TEMPBSICILE_view",
				"ctype"=>"2DDoughnut"));
			$this->assign_function("tempbsicis_view2_chart","xt_showchart",
			array(
				"chartName"=>"tempbsicis_view2",
				"table"=>"TEMPBSICIS_view2",
				"ctype"=>"2DColumn"));
			$this->assign_function("tempbsicit_view2_chart","xt_showchart",
			array(
				"chartName"=>"tempbsicit_view2",
				"table"=>"TEMPBSICIT_view2",
				"ctype"=>"2DColumn"));
			$this->assign_function("chart_summary_report_view_chart","xt_showchart",
			array(
				"chartName"=>"chart_summary_report_view",
				"table"=>"Chart_summary_report_view",
				"ctype"=>"2DPie"));
			$this->assign_function("report_product_month_view_chart","xt_showchart",
			array(
				"chartName"=>"report_product_month_view",
				"table"=>"report_product_Month_view",
				"ctype"=>"2DDoughnut"));
		}
