...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "u736239518_btn_at_154_41_241_2";
		$data["connName"] = "u736239518_btn at 154.41.241.2";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;154.41.241.2;u736239518_btn;Userbtn2024\$\$;;u736239518_btn;;1"; //currently unused

		$this->_connectionsIdByName["u736239518_btn at 154.41.241.2"] = "u736239518_btn_at_154_41_241_2";

		$data["connInfo"] = array();
		$data["ODBCUID"] = "u736239518_btn";
		$data["ODBCPWD"] = "Userbtn2024\\\$\\\$";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][0] = "154.41.241.2";
		$data["connInfo"][1] = "u736239518_btn";
		$data["connInfo"][2] = "Userbtn2024\$\$";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "u736239518_btn";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=154.41.241.2;Uid=u736239518_btn;Pwd=Userbtn2024\$\$;Database=u736239518_btn;OPTION=3";
		// encription set
		...
		$connectionsData["u736239518_btn_at_154_41_241_2"] = $data;
