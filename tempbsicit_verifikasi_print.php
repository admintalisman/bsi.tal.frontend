...
require_once("include/tempbsicit_verifikasi_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "TEMPBSICIT_verifikasi" );
